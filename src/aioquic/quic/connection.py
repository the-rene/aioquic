...
class QuicConnection:
    ...
    def __init__(
        ...
        *,
        ...
        self._host_cids = [
            QuicConnectionId(
                cid=(configuration.connection_id_length -1 )*b'\x00'+os.urandom(1),
                sequence_number=0,
        ...
        self._peer_cid = (configuration.connection_id_length -1 )*b'\x00'+os.urandom(1)
        ...
        self.__frame_handlers = {
            ...
            0x13: (self._handle_max_streams_uni_frame, EPOCHS("ZO")),
            0x14: (self._handle_data_blocked_frame, EPOCHS("ZO")),
            0x15: (self._handle_stream_data_blocked_frame, EPOCHS("ZO")),
            0x16: (self._handle_streams_blocked_frame, EPOCHS("ZO")),
            0x17: (self._handle_streams_blocked_frame, EPOCHS("ZO")),
            0x18: (self._handle_new_connection_id_frame, EPOCHS("ZO")),
            0x19: (self._handle_retire_connection_id_frame, EPOCHS("O")),
            0x1A: (self._handle_path_challenge_frame, EPOCHS("ZO")),
    ...
    def _replenish_connection_ids(self) -> None:
        ...
        while len(self._host_cids) < min(8, self._remote_active_connection_id_limit):
            self._host_cids.append(
                QuicConnectionId(
                    cid=(self._configuration.connection_id_length -1 )*b'\x00'+os.urandom(1),
